...
class RecipeConfigurationProvider extends ChangeNotifier {
  RecipeConfigurationProvider() {
  ...
  static late final RecipeConfigurationProvider instance; // Singleton pattern
